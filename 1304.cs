...
namespace PracticeApp
{
    public partial class Form1 : Form
    {
        ...
        // 1. Кнопка яка "тікає" при наведені на неї мишкою.
        ...
        // 3. Функціонал який відкриває текстовий файл. Забирає його контент і дає редагувати і після збереження апдейтить.
